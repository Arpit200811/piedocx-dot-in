...
const StudentRegistration = () => {
   ...
   const onSubmit = async (data) => {
      try {
         ...
         const response = await fetch(`${base_url}/api/certificate/register`, {
            method: 'POST',
         ...
         if (response.ok) {
            ...
            const errorMessage = resData.message || "Registration failed.";
         ...
         Swal.fire('Network Issue', 'Cloud synchronization failed. Please check your connection.', 'error');
      }
   };
