  ...
  const features = [
    {
      ...
      desc: "Instant data streaming from remote sensors with MQTT and WebSockets.",
      icon: <Wifi className="w-5 h-5" />,
      delay: 0
    },
    {
      title: "Edge Computing",
      desc: "Process data locally on devices for zero-latency decision making.",
      icon: <Cpu className="w-5 h-5" />,
      delay: 50
    },
    {
      title: "Industrial IoT",
      desc: "Smart factory automation and predictive maintenance pipelines.",
      icon: <Activity className="w-5 h-5" />,
      delay: 100
    },
    {
      title: "Device Management",
      desc: "Centralized control for fleets of thousands of connected devices.",
      icon: <Settings className="w-5 h-5" />,
      delay: 150
    },
    {
      title: "Hardware Integration",
      desc: "Seamless bridging of distinct hardware protocols (Zigbee, LoRaWAN).",
      icon: <Radio className="w-5 h-5" />,
      delay: 200
    },
    {
      title: "IoT Security",
      desc: "End-to-end encryption for device-to-cloud data transmission.",
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <div data-aos="fade-right">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-6 tracking-tighter italic">
              Intelligent <br /> <span className="text-blue-600 underline decoration-blue-100 underline-offset-4">Everything.</span>
            </h1>
            <p className="text-base text-slate-600 leading-relaxed mb-8 max-w-lg font-medium">
              We bridge the physical and digital worlds. From embedded sensors to cloud analytics, we engineer the nervous system of your business.
            </p>
          ...
          <div className="relative scale-90 md:scale-100" data-aos="zoom-in">
             ...
             <div className="relative bg-slate-900 rounded-[2.5rem] p-8 border border-slate-800 shadow-2xl overflow-hidden group max-w-md mx-auto">
                <div className="flex items-center justify-between mb-8">
                   ...
                   <p className="text-[10px] font-mono text-slate-500">iot_gateway_v4</p>
                </div>
                <div className="space-y-4">
                   <div className="flex justify-between items-center text-blue-400 font-mono text-[10px]">
                      <span>Sensor_01</span>
                      <span>Active (24ms)</span>
                   </div>
                   ...
                   <div className="grid grid-cols-4 gap-2 mt-6">
                      {[1,2,3,4].map(i => <div key={i} className="h-10 bg-white/5 rounded-lg border border-white/5 animate-pulse"></div>)}
                   </div>
                </div>
             </div>
          </div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-5xl mx-auto rounded-[3rem] bg-blue-600 p-12 text-center text-white relative shadow-2xl overflow-hidden">
           ...
           <div className="relative z-10" data-aos="zoom-up">
              <h3 className="text-3xl md:text-4xl font-black mb-6 tracking-tighter italic uppercase">Connect The Unconnected.</h3>
              <p className="text-blue-100 text-base mb-10 max-w-lg mx-auto font-medium">
                 Start your industrial revolution with our IoT architects today.
              </p>
