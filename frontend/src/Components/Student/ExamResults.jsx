            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2">
                        {/* Score Circle Area */}
                        <div className="p-12 md:p-16 flex flex-col items-center justify-center bg-slate-900 text-white relative">
                            ...
                            >
                                <svg className="w-full h-full -rotate-90">
                                    ...
                                    <motion.circle
                                        cx="128" cy="128" r="110" fill="transparent" stroke="#2563eb" strokeWidth="12"
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                                    <motion.div 
                                        ...
                                        transition={{ delay: 1 }}
                                    >
                                        <span className="text-7xl font-black italic tracking-tighter leading-none">{results.score}</span>
                                        <p className="text-xs font-black text-blue-400 uppercase tracking-[0.4em] mt-2 opacity-60">Out of {results.total}</p>
                                    </motion.div>
                                </div>
                            </motion.div>
                            
                            <div className="mt-12 text-center space-y-2 relative z-10">
                                <h3 className="text-xl font-black uppercase italic tracking-widest text-blue-500">Performance Index</h3>
                                <p className="text-slate-400 text-xs font-bold uppercase tracking-[0.2em]">{results.title}</p>
                            </div>
                        </div>

                        {/* Stats Breakdown Area */}
                        <div className="p-12 md:p-16 space-y-8 relative z-10 bg-white">
