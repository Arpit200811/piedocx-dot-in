...
import { 
  ...
  Brain, Link2, ChevronRight, Globe2
} from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Blockchain solutions and penetration testing to ensure your digital assets remain impenetrable.",
      tech: ["Solidity", "Eth", "Web3", "Vault"],
      features: ["DApps", "Security Audits", "Web3"]
    }
  ];
